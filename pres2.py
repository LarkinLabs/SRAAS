...
ZED_Thread = Thread(target=ZedCamera, args=(0,))
...
#Goto = [(5000,0),(5000,4000), (0,4000),(0,0)]
##Goto = [(0,0),(100,-500),(750,-1300),(1200,-1500),(1700,-1500),(2200,-1300),(2700,-1000),(2900,-500),(3000,0),(2900,500),
##        (2600,1000),(2200,1300),(1700,1500),(1200,1500),(750,1300),(350,1000),(100,500)]
##Goto = [(100,-500),(1200,-1500),(2200,-1300),(2900,-500),(2900,500)
##         ,(2600,1000),(2200,1300),(1700,1500),(1200,1500),(750,1300),
##         (350,1000),(100,500)]
...
##            img = cv2.circle(img,(int((IMU_X_Pos/100)+250),int((IMU_Y_Pos/100)+250)), 1, (120,120,0), -1) #imu Img
    ...
    if MODE == 2 or MODE == 1: # mode 2 is set in the logitech module
        Data_Save.queue.clear()
        Data_Save.put((Batt,(CenterDist,Theta,Xpos,Ypos),GPS_data,IMUData,UltraData,ZED_Math,d4d,img))
    ...
    try:
        ...
        cv2.imshow('ZED', cv2.line(ZED_Math_line, (0, ZedLine), (679, ZedLine), (255,255,255), 2))
